...
def main():
    ...
    # 1. ログイン用URLの生成
    login_url = f"https://auth.tesla.com/oauth2/v3/authorize?client_id={CLIENT_ID}&redirect_uri=https://cooper-duplicate-joan-exit.trycloudflare.com/callback&response_type=code&scope=openid%20vehicle_device_data%20vehicle_charging_cmds&state=12345"
